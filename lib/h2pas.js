...
class processHeaderFile {
    ...
    constructor(filePath) { this.#fileData = fs.readFileSync(filePath); this.#filePath = filePath; this.#fileDir = path.dirname(filePath); }
    ...
    async loadIncludeFile(includeFileList = []) {
        let tmpObject;
